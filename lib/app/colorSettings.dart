            ...
            for (int x in shades)
              for (int i = start; i < 255; i += incr)
                InkWell(
                  onTap: () {
                    ref.read(colorProvider.notifier).state =
                        Color.fromRGBO(255, i, x, 1);
                    Navigator.of(context).pop();
                  },
                  child: Ink(
                      height: sz,
                      width: sz,
                      color: Color.fromRGBO(255, i, x, 1)),
                ),
            for (int x in shades)
              for (int i = start; i < 255; i += incr)
                InkWell(
                  onTap: () {
                    ref.read(colorProvider.notifier).state =
                        Color.fromRGBO(255, x, i, 1);
                    Navigator.of(context).pop();
                  },
                  child: Ink(
                      height: sz,
                      width: sz,
                      color: Color.fromRGBO(255, x, i, 1)),
                ),
            for (int x in shades)
              for (int i = start; i < 255; i += incr)
                InkWell(
                  onTap: () {
                    ref.read(colorProvider.notifier).state =
                        Color.fromRGBO(i, 255, x, 1);
                    Navigator.of(context).pop();
                  },
                  child: Ink(
                      height: sz,
                      width: sz,
                      color: Color.fromRGBO(i, 255, x, 1)),
                ),
            for (int x in shades)
              for (int i = start; i < 255; i += incr)
                InkWell(
                  onTap: () {
                    ref.read(colorProvider.notifier).state =
                        Color.fromRGBO(x, 255, i, 1);
                    Navigator.of(context).pop();
                  },
                  child: Ink(
                      height: sz,
                      width: sz,
                      color: Color.fromRGBO(x, 255, i, 1)),
                ),
            for (int x in shades)
              for (int i = start; i < 255; i += incr)
                InkWell(
                  onTap: () {
                    ref.read(colorProvider.notifier).state =
                        Color.fromRGBO(i, x, 255, 1);
                    Navigator.of(context).pop();
                  },
                  child: Ink(
                      height: sz,
                      width: sz,
                      color: Color.fromRGBO(i, x, 255, 1)),
                ),
            for (int x in shades)
              for (int i = start; i < 255; i += incr)
                InkWell(
                  onTap: () {
                    ref.read(colorProvider.notifier).state =
                        Color.fromRGBO(x, i, 255, 1);
                    Navigator.of(context).pop();
                  },
                  child: Ink(
                      height: sz,
                      width: sz,
                      color: Color.fromRGBO(i, i, 255, 1)),
                ),
            for (int i = start; i < 255; i += incr)
              InkWell(
                onTap: () {
                  ref.read(colorProvider.notifier).state =
                      Color.fromRGBO(i, i, 255, 1);
                  Navigator.of(context).pop();
                },
                child: Ink(
